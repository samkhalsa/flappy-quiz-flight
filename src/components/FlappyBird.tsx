...
const FlappyBird: React.FC = () => {
  ...
  const updateGame = useCallback(() => {
    ...
    setGameState(prev => {
      // If there's an active question, freeze everything except rendering
  ...
  const handleJump = useCallback(() => {
    // Don't allow jumping during questions
  ...
  }, [gameState.gameOver, gameState.gameStarted, activeQuestionZone]);
